...
- domain (short lowercase slug. Use a known slug when it clearly fits: discord, weather, web-framework, data-science, web-crawler, testing, http-client. Otherwise use a precise free-form slug such as music-generation, image-processing, vector-database, browser-automation, or general only when the idea is truly generic)
